          ...
          <div className="w-full max-w-[440px]">
            ...
            <div className="glass-panel rounded-xl p-8 sm:p-10 shadow-[0_12px_32px_-4px_rgba(67,82,165,0.06)] ring-1 ring-outline-variant/15">
              <header className="mb-8">
                <h1 className="font-headline font-bold text-2xl tracking-tight text-on-surface mb-1">Welcome back</h1>
                <p className="text-on-surface-variant font-label text-sm">Please enter your details to sign in.</p>
              </header>
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-label tracking-widest text-on-surface-variant/40">
                  <span className="bg-surface/80 backdrop-blur-md px-4">Or continue with</span>
                </div>
              </div>
