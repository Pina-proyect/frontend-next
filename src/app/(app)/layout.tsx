    ...
    <div className="flex min-h-screen bg-surface font-body text-on-surface antialiased">
      ...
      <aside className="bg-surface-container-high h-screen w-64 hidden lg:flex flex-col sticky top-0 border-r border-outline-variant/10">
        <div className="flex flex-col p-6 gap-8 h-full">
          ...
          {/* New Post CTA */}
          <button className="bg-gradient-to-br from-primary to-primary-container text-white py-3 px-4 rounded-xl flex items-center justify-center gap-2 font-semibold shadow-[0_12px_32px_-4px_rgba(67,82,165,0.2)] hover:opacity-90 active:scale-95 transition-all">
